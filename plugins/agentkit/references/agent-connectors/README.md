...
| [Attention](attention.md) | Meeting intelligence and note-taking | API Key |
| [Chorus](chorus.md) | Conversation intelligence for sales | OAuth 2.0 |
| [Clari Copilot](clari_copilot.md) | Revenue intelligence and forecasting | API Key |
| [Google Slides](google_slides.md) | Google Slides presentation editing | OAuth 2.0 |
